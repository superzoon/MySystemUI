...
import cn.nubia.systemui.renderer.Constant;
class MySurfaceView extends GLSurfaceView
{
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onDrawFrame(GL10 gl)
        {
            ...
            //绘制后墙
            MatrixState.pushMatrix();
            MatrixState.translate(0, 0, -Constant.UNIT_SIZE+tzz);
            ...
            //绘制左墙
            MatrixState.pushMatrix();
            MatrixState.translate(-Constant.UNIT_SIZE+tzz, 0, 0);
            ...
            //绘制下墙
            MatrixState.pushMatrix();
            MatrixState.translate(0, -Constant.UNIT_SIZE+tzz, 0);
